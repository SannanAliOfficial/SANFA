                                    ...
                                    <div class="col-md-6">
                                        <div class="about-contentbox">
                                            <div class="animate" data-animate="fadeInUp">
                                                <span>About Us</span>
                                                <h2>What is Sanfa</h2>
                                                <p><strong>Sanfa</strong> is shaping the future
                                                    through a paradigm shift as a
                                                    Technology Company with a Banking License. <strong>SANFA</strong> is proud to present a revalotionary Banking system to all your personal needs. We got you covered.
                                                    Let US help grow your business with around the clock support from our team.
                                                    <br>  
                                            </p>
                                            </div>
                                            <div class="facts-list owl-carousel">
                                                <div class="item animate" data-animate="fadeInUp">
                                                    <div class="counter-box">
                                                        <i class="fa fa-trophy counter-icon" aria-hidden="true"></i><span class="count-number">32</span>Domestic Awards Won
                                                    </div>
                                                </div>
                                                ...
                                                <div class="item animate" data-animate="fadeInUp">
                                                    <div class="counter-box">
                                                        <i class="fa fa-support counter-icon" aria-hidden="true"></i><span class="count-number">2</span> Team Members
                                                    </div>
                                                </div>
                                                <div class="item animate" data-animate="fadeInUp">
                                                    <div class="counter-box">
                                ...
                                <div class="services-list owl-carousel">
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="service-box">
                                            ...
                                            <p>We take care of your accounts and manage it accordingly </p>
                                        </div>
                                    </div>
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="service-box">
                                            ...
                                            <p>We provide you with monthly bank statements with proper transaction history. </p>
                                        </div>
                                    </div>
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="service-box">
                                            ...
                                            <h3>Sanfa Mobile</h3>
                                            <p>WHO DOESN'T LOVE DISCOUNTS?
                                                with our mobile app, there are lots of discounts
                                            </p>
                                        </div>
                                    </div>
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="service-box">
                                            ...
                                            <p>We provide a wide range of debit/credit cards which can avail you upto 100% off on my places</p>
                                        </div>
                                    </div>
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="service-box">
                                    ...
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="service-box">
                                            ...
                                            <p>Our websites and mobile app is working 24/7 all around the globe</p>
                                        </div>
                                    </div>
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="service-box">
                                            ...
                                            <p>At Webflow, we're constantly updating, improving, and bug-fixing — and you'll instantly and painlessly benefit from every update, without doing a thing. </p>
                                        </div>
                                    </div>
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="service-box">
                                            ...
                                            <p>At the most basic level, it can help ensure your website is always available and running smoothly. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="section-inner">
                    <div class="row justify-content-center">
                        <div class="col-md-7 wide-col-laptop">
                            <div class="title-block animate" data-animate="fadeInUp">
                                <span>Our Shares</span>
                                <h2>Where Do we Invest?</h2>
                            </div>
